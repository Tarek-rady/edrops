<td>
    <div class="hstack gap-3 flex-wrap">
        @if(auth('admin')->user()->hasPermission('news-update'))
         <a href="{{ route('admin.news.edit' , $id) }}" class="link-success fs-15 icon1"><i class="ri-edit-2-line"></i></a>
        @endif
...
@php
    $artical = App\Models\News::where('id' , $id)->first();
@endphp
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            ...
                            <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                ...
                                <p class="text-muted mx-4 mb-0">{{ $artical->title }}</p>
                            </div>
                        </div>
