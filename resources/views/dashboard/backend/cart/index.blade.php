...
@section('content')
    ...
    <form action="{{route('admin.cart.make_order')}}" method="POST" id="cartOrderForm">
        @csrf
        <div class="row mb-3">
            <div class="col-xl-8">
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                ...
                                <div class="col-sm">
                                    ...
                                    <p> {{ __('models.sku') }} : {{ $cart_item->product->sku }}</p>
...
@section('js')
    ...
    <script>
        ...
        function makeCartOrder(){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.cart.make_order')}}",
                data: formDataObject,
                success: function(response) {
                    $('#loader-overlay').hide();
                    if(response.success){
