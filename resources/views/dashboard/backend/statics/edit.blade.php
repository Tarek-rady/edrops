    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('models.edit_static') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.statics.index') }}">{{ __('models.statics') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('models.edit_static') }}</li>
                        </ol>
                    </div>
        ...
        <div class="card-body">
            <div class="live-preview">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{ route('admin.statics.update' , $static->id) }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="desc_ar" value="{{ old('desc_ar' , $static->desc_ar) }}" id="desc_ar"  required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                        @error('desc_ar')
