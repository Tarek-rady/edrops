            ...
            <div class="card-body">
                <div class="listjs-table" id="customerList">
                    <div class="row g-4 mb-3">
                        ...
                        @if(auth('admin')->user()->hasPermission('steps-create'))
                            <div class="col-sm-auto">
                                <div>
                                    <a href="{{ route('admin.steps.create') }}" class="btn btn-success add-btn" ><i class="ri-add-line align-bottom me-1"></i>{{ __('models.add_step') }}</a>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="table-responsive table-card mt-3 mb-1">
                        <table class="table align-middle table-nowrap" id="steps_table">
                            <thead class="table-light">
                                <tr>

                                    <th class="sort">{{ __('models.steps') }}</th>
