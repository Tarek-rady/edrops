    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('models.add_type') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.types.index') }}">{{ __('models.types') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('models.add_type') }}</li>
                        </ol>
                    </div>
        ...
        <div class="card-body">
            <div class="live-preview">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{ route('admin.types.store') }}" enctype="multipart/form-data" novalidate>
