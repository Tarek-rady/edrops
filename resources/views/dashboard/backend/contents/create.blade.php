    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('models.add_content') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.contents.index') }}">{{ __('models.contents') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('models.add_content') }}</li>
                        </ol>
                    </div>
        ...
        <div class="card-body">
            <div class="live-preview">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{ route('admin.contents.store') }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="col-md-6 col-12 mb-3">
                        ...
                        <textarea class="form-control editor"  cols="70" rows="20" name="desc_ar" >{{ old('desc_ar') }}</textarea>
                    ...
                    <div class="col-md-6 col-12 mb-3">
                        ...
                        <textarea class="form-control editor" cols="70" rows="20"  name="desc_en" >{{ old('desc_en') }}</textarea>
