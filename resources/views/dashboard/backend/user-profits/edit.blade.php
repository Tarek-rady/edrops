                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.user-pulls.index') }}">{{ __('models.pulls') }}</a></li>
        ...
        <div class="card-body">
            <div class="live-preview">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{ route('admin.post-user-pulls') }}" enctype="multipart/form-data" novalidate>
                    ...
                    <input type="hidden" name="saller_id" id="{{ $user->id }}" value="{{ $user->id }}">

                    @php
                        $user_amount = $user->amount - $user->pulls->sum('pull') ;
                        $user_pull = $payout->pull ;
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="saller_amount" name="saller_amount" value="{{ $user_amount }}" id="saller_amount"  readonly>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="pull" name="pull" value="{{ $user_pull }}" id="pull"  required>
