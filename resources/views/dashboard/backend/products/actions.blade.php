<td>
    <div class="hstack gap-2 flex-wrap">
        ...
        @if(auth('admin')->user()->hasPermission('products-read'))
          <a href="{{ route('admin.products.show' , $id) }}" class="link-info fs-15 icon2"><i class="ri-eye-2-line"></i></a>
        @endif
        @if(auth('admin')->user()->hasPermission('products-update'))
         <a href="{{ route('admin.products.edit' , $id) }}" class="link-success fs-15 icon1 icon3"><i class="ri-edit-2-line"></i></a>
        @endif
