...
<button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModalScrollable{{ $id }}"> Message </button>
@php
            ...
            <div class="modal-body">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-2">
                        <p class="text-muted mb-0">{{ $contact->msg }}</p>
                    </div>
                </div>
