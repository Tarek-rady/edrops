<td>
    <div class="hstack gap-3 flex-wrap">
        @if(auth('admin')->user()->hasPermission('cities-update'))
         <a href="{{ route('admin.cities.edit' , $id) }}" class="link-success fs-15 icon1"><i class="ri-edit-2-line"></i></a>
        @endif
        @if(auth('admin')->user()->hasPermission('cities-delete'))
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            ...
                            <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                ...
                                <p class="text-muted mx-4 mb-0">{{ $city->name }}</p>
                            </div>
                        </div>
