                    ...
                    <div class="row g-4 mb-3">
                        ...
                        @if(auth('admin')->user()->hasPermission('sallers-create'))
                            <div class="col-sm-auto">
                                <div>
                                    <a href="{{ route('admin.sallers.create') }}" class="btn btn-success add-btn" ><i class="ri-add-line align-bottom me-1"></i>{{ __('models.add_saller') }}</a>
                                </div>
                            </div>
                        @endif
                        ...
                        <x-select col="4" name="city_id" label="{{ __('models.cities') }}" :options="[]" />
