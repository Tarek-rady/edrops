        ...
        <div class="container">
            ...
            <div class="login">
                <div class="row my-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">تسجيل دخول الموردين</p>

                                </div>
                                <div class="p-2 mt-5">
                                    <form class="needs-validation" novalidate action="{{ route('user.login.post') }}"
                                        method="POST">
                                        @csrf
                    ...
                    <div class="col-6">
                        <img src="{{ asset('img/login-user.png') }}" class="w-100" alt="">
                    </div>
                </div>
            </div>
