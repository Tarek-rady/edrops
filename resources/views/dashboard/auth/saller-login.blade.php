        ...
        <div class="container">
            ...
            <div class="login">
                <div class="row my-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">تسجيل دخول  {{ __('models.sallers') }}</p>

                                </div>
                                <div class="p-2 mt-5">
                                    <form class="needs-validation" novalidate action="{{ route('saller.login.post') }}"
                                        method="POST">
                                        @csrf
                    ...
                    <div class="col-6">
                        <img src="{{ asset('img/login-imh.png') }}" class="w-100" alt="">
                    </div>
                </div>
            </div>
