...
{{--  id="ckeditor-classic"  --}}
<form  class="row g-3 needs-validation" method="POST" action="{{ route('user.products.store') }}" enctype="multipart/form-data" novalidate>
    @csrf
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sku" name="sku" value="{{ old('sku') }}" placeholder="Enter product Name English" id="meta-keywords-input" required>
                            </div>
                            @error('sku')
                                <span class="text-danger">
                                    <small class="errorTxt">{{ $message }}</small>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control js-example-basic-multiple" name="brand_id"   id="brand_id">
                                <option value=""disabled> {{ __('models.brands') }} </option>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            ...
                                            <input type="text" class="form-control" id="cost_user" value="{{ old('cost_user') }}" name="cost_user" placeholder="Enter Product Cost" aria-label="cost_user" aria-describedby="product-cost_user-addon" required>
                                        </div>
                        ...
                        <div class="tab-pane" id="product-sizes" role="tabpane2">
                            <div class="d-grid gap-2" >
                                <a href="" class="btn btn-danger waves-effect waves-light btn-block add-input-value-size">{{ __('models.add_sizes') }}</a><br>
                            </div>
                            <div class="row">
                        ...
                        <div class="tab-pane" id="product-colors" role="tabpane3">
                            ...
                            <div class="d-grid gap-2" >
                                <a href="" class="btn btn-primary waves-effect waves-light btn-block add-input-value-color">{{ __('models.add_colors') }}</a><br>
                            </div>
