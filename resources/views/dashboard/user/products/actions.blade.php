<td>
    <div class="hstack gap-2 flex-wrap">
        <a href="{{ route('user.products.show' , $id) }}" class="link-info fs-15 icon2"><i class="ri-eye-2-line"></i></a>
        <a href="{{ route('user.products.edit' , $id) }}" class="link-success fs-15 icon1 icon3"><i class="ri-edit-2-line"></i></a>
...
<!-- Modal -->
    <div class="modal fade zoomIn" id="deleteRecordModal{{ $id }}" tabindex="-1" aria-hidden="true">
        <form action="{{ route('user.products.destroy' , $id) }}" method="POST">
            @method('DELETE')
            @csrf
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            ...
                            <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                ...
                                <p class="text-muted mx-4 mb-0">{{ $product->name }}</p>
                            </div>
                        </div>
