        ...
        <div class="col-md-8">
            <div class="wallet-card seller-profile">
                <div class="row">
                    <div class="col-sm-5">
                        <div class="image">
                            <img src="{{ $user->img ? asset('storage') . '/' . $user->img : asset('storage/users/1.png')}}" alt="seller image" style="width:200px;height:200px">
                        </div>
                    </div>
                    <div class="col-sm-7">
...
@section('js')
    ...
    <script>
        ...
        function checkAmount() {
            ...
            var seller_balance = {{ $user->amount }};
        ...
        function submitForm(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('user.wallet.make_payout_request') }}",
                data: formDataObject,
