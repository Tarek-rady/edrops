        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('models.edit_category') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.categories.index') }}">{{ __('models.categories') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('models.edit_category') }}</li>
                        </ol>
                    </div>
            ...
            <div class="live-preview">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{ route('admin.categories.update' , $category->id) }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group prev">
                        <img src="{{ asset('storage/' . $category->img) }}" style="width: 100px" class="img-thumbnail preview-formFile" alt="">
                    </div>
