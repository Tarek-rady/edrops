                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control js-example-basic-multiple" name="countries[]" id="countries" multiple>
                                ...
                                @foreach ( $countries as $country )
                                    <option value="{{ $country->id }}" @foreach ($product->countries as $product_country)
                                         {{ $product_country->country_id == $country->id ? 'selected' : ''  }}
                                    @endforeach >{{ $country->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <!-- end col -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            ...
                                            <input type="text" class="form-control" id="cost" value="{{ old('cost' , $product->cost) }}" name="cost" placeholder="Enter cost" aria-label="cost" aria-describedby="product-cost-addon" required>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            <span class="input-group-text"></span>
                                            <input type="text" class="form-control" id="price" value="{{ old('price' , $product->price) }}" name="price" placeholder="Enter price" aria-label="price" aria-describedby="product-price-addon" required>
                                 ...
                                 <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            <span class="input-group-text"></span>
                                            <input type="number" class="form-control" id="profit" value="{{ old('profit' , $product->profit) }}" name="profit" placeholder="Enter profit" aria-label="profit" aria-describedby="product-profit-addon" readonly>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            ...
                                            <input type="text" class="form-control" id="product-ratio-input" value="{{ old('ratio' , $product->ratio) }}" name="ratio" placeholder="Enter ratio" aria-label="ratio" aria-describedby="product-ratio-addon" >
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            ...
                                            <input type="text" class="form-control" id="product-delivery-input" value="{{ old('delivery' , $product->delivery) }}" name="delivery" placeholder="Enter delivery" aria-label="delivery" aria-describedby="product-delivery-addon">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group has-validation mb-3">
                                            ...
                                            <input type="number" class="form-control" id="product-competition-input" value="{{ old('competition' , $product->competition) }}" name="competition" placeholder="Enter competition" aria-label="competition" aria-describedby="product-competition-addon" >
