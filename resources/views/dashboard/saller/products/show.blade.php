        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ __('models.products') }}">{{ __('models.products') }}</a></li>
                            ...
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="hstack gap-3 flex-wrap">
                                        ...
                                        <div class="vr"></div>
                                        <div class="text-muted">{{ __('models.created_at') }} : <span class="text-body fw-medium">{{ $product->created_at->format('d-m-y') }}</span></div>
                                        <div class="vr"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="p-2 border border-dashed rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <p class="text-muted mb-1">{{ __('models.profit') }} :</p>
