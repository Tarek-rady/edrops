...
<div class="container-fluid">
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="{{ $saller->img ? asset('storage/' . $saller->img) : asset('storage/admins/1.png') }}" alt="user-img" class="img-thumbnail rounded-circle" />
                </div>
            </div>
            <!--end col-->
            <div class="col">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <div class="fs-16 align-middle text-warning">
                                                ...
                                                @for ($i =1 ; $i < 6 ; $i++)
                                                    <i class="ri-star-{{ $saller->avg_rates() >= $i ? 'fill' : ''}} "></i>
                                                @endfor
                                            </div>
                                        </div>
                                        <div class="flex-shrink-0">
